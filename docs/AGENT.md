...
- `web/index.html` 可載入快照與即時 GitHub 資料，頁尾載有 Andy87877 CC0-1.0 視覺化徽章與授權宣告，且多語言與 Topic 複選過濾、動態分頁導航 (首頁/上一頁/頁碼統計/下一頁/末頁)、數據分析 Dashboard Modal (含 Starred & Created 雙軸趨勢)、⌨️ 鍵盤快捷鍵 Modal、目前篩選條件標籤列、點擊標頭排序 (支援 Stars/創建日期/收藏日期) 與 CSV 格式導出功能正常。
